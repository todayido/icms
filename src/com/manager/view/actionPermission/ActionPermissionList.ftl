		...
		<tr>
			<td>
				<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-add" plain="true" 
				   onclick="javascrip:$('#permissionDlg').utilsOpenDialogAdd('dataTable',500,350,'添加信息','/permission/permissionAdd.htm?parent_id=${parent_id}');">新增</a>
				<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-save" plain="true" 
				    onclick="javascript:$('#permissionDlg').utilsOpenDialogModify('dataTable','permission_id',500,350,'信息修改','/permission/permissionModify.htm')">修改</a>
...
<table id="dataTable" class="easyui-datagrid" url="/permission/permissionList.htm?parent_id=${parent_id}" iconCls="icon-save" loadMsg="数据加载中,请稍后……"
