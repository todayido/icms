...
insert  into `z_action`(`actionid`,`actionname`,`actionurl`,`viewfile`,`contentfile`,`description`,`createtime`) values ('12','xxx','fragment/fragmentBlock/1','classes/com/fragment/view/v/JianRuShouShoucang.ftl','','',NULL),('13','','login/login','','zhiyoudaohanghebanquan.ftl','',NULL),('14','','login/managelogin','','','',NULL),('15','','news/details','','main.ftl','',NULL),('16','','news/list','','main.ftl','',NULL),('17','','fragment/fragmentBlock/2','templates/views/fragment/main-top-banner.ftl','','',NULL),('18','','fragment/fragmentBlock/3','templates/views/fragment/main-top-addtofavorite.ftl','','',NULL),('19','','fragment/fragmentBlock/4','templates/views/fragment/main-bottom-copyright.ftl','','','2016-02-17 16:12:53'),('20','','fragment/fragmentBlock/5','templates/views/fragment/main-navigation.ftl','','','2016-02-18 11:42:15'),('21','','news/block/2','','main.ftl','',NULL),('22','','fragment/fragmentBlock/7','templates/views/fragment/main-contact-us.ftl','','','2016-02-22 10:16:38'),('23','','fragment/fragmentBlock/8','templates/views/fragment/main-ids.ftl','','','2016-02-23 16:34:25'),('24','','item/itemBlock','','main.ftl','',NULL),('25','','fragment/fragmentBlock/9','templates/views/fragment/back-to-top.ftl','','','2016-03-08 22:54:06'),('26','','news/block/3','','main.ftl','',NULL),('27','','fragment/fragmentBlock/11','templates/views/fragment/left-nav.ftl','','','2016-04-10 00:46:56'),('28','','fragment/fragmentBlock/12','','main.ftl','','2016-05-03 11:19:48'),('29','','fragment/fragmentBlock/10','','main.ftl','','2016-05-03 11:21:19'),('30','','register/register','','main.ftl','',NULL),('31','','login/doLogin','','zhiyoudaohanghebanquan.ftl','',NULL),('32','','member/memberInfo','','main.ftl','',NULL),('33','','fragment/fragmentBlock/13','templates/views/fragment/operation-flow.ftl','','','2016-05-14 23:35:37'),('34','','pay/zhifubao','','main.ftl','',NULL),('35','','member/modifyPass','','main.ftl','','2016-05-17 00:18:42'),('36','','member/modifyPassSumit','','main.ftl','','2016-05-17 10:35:23'),('37','','payLog/auditSubmit','','','',NULL),('38','','pay/zhifubaoSubmit','','main.ftl','',NULL),('39','','register/doRegister','','main.ftl','','2016-05-17 13:29:22'),('40','','pay/withdraw','','main.ftl','','2016-05-17 15:57:48'),('41','','pay/withdrawSubmit','','main.ftl','','2016-05-18 15:21:16'),('42',NULL,'item/itemPublish','','main.ftl','','2016-12-09 11:07:29'),('7','','login/doManagelogin','','','',NULL),('8',NULL,'news/block','','portal.ftl','',NULL);
...
insert  into `z_depart`(`depart_id`,`parent_id`,`name`,`number`,`has_next`,`priority`,`is_show`,`create_time`) values ('1','','中国','00','1',0,'1','2015-05-21 06:01:03'),('10','3','临沂','0539','0',2,'1','2015-12-31 10:42:42'),('11','1','广州','0102','0',0,'1','2016-12-09 11:11:44'),('3','1','山东','0531','1',0,'1','2015-05-25 11:39:55'),('4','1','北京','010','0',0,'1','2015-06-03 16:10:09'),('6','1','上海','0101','0',0,'1','2015-07-24 16:51:46'),('8','3','济南','0531','0',10,'1','2015-10-12 21:58:13');
...
/*Table structure for table `z_fragment` */

DROP TABLE IF EXISTS `z_fragment`;

CREATE TABLE `z_fragment` (
...
insert  into `z_menu_permission`(`PERMISSION_ID`,`PERMISSION_NAME`,`PARENT_ID`,`RESOURCE`,`DESCRIPTION`,`HAS_NEXT`,`PRIORITY`) values ('1','权限管理','0','permission-manage-menu','权限管理菜单','1',2),('13','网站管理','0','site-manage-menu','网站管理菜单','1',1),('14','模板管理','13','template/templateIndex.htm','模板管理菜单','0',0),('16','角色维护','1','role/roleIndex.htm','角色维护菜单','0',2),('17','频道管理','13','chanel/chanelIndex.htm','频道管理菜单','0',0),('18','视图管理','13','view/viewIndex.htm','视图管理菜单','0',0),('19','动作配置','13','action/actionIndex.htm','动作配置菜单','0',0),('2','用户管理','1','user/userIndex.htm','用户管理菜单','0',1),('20','组件管理','13','component/componentIndex.htm','组件管理菜单','0',0),('21','组件实例','13','component-instance-menu','组件实例','1',0),('22','页面片段','21','fragment/fragmentIndex.htm','页面片段菜单','0',0),('23','新闻实例','21','newsproperty/newspropertyIndex.htm','新闻实例菜单','0',0),('25','网站信息','0','site-info-menu','网站信息菜单','1',4),('26','新闻维护','25','news/newsMgrMain.htm','新闻维护菜单','0',0),('3','权限管理','1','permission/permissionMenuIndex.htm','权限管理菜单','0',3),('36','参数维护','0','site-params','参数维护菜单','1',3),('37','缓存清理','36','manage/cacheIndex.htm','缓存清理菜单','0',0),('38','字典定义','37','dictionary/dictionaryIndex.htm','字典定义菜单','0',0),('39','组织机构','1','depart/departMgrTreeIndex.htm','组织机构','0',0),('40','菜单权限','1','menu/menuTreeIndex.htm','菜单权限','0',2);
...
insert  into `z_sequence`(`TABLENAME`,`NEXTVALUE`) values ('t_fragment','13'),('t_news','29'),('t_news_property','4'),('t_user_pay','3'),('z_action','42'),('z_chanel','13'),('z_component','9'),('z_depart','11'),('z_dictionary','20'),('z_menu','27'),('z_permission','48'),('z_role','5'),('z_role_permission','76'),('z_template','22'),('z_user','24'),('z_user_role','49'),('z_view','29');
...
insert  into `z_user`(`USER_ID`,`USER_NAME`,`PASSWORD`,`DEPART_ID`,`USER_ALIAS`,`DUTY_ID`,`EMAIL`,`QUESTION`,`ANSWER`,`QQ_NUMBER`,`PHONE`,`PRIORITY`,`REG_TIME`,`LOGIN_ERROR_TIMES`,`LAST_LOGIN_TIME`,`LAST_LOGIN_IP`,`LOGIN_TIMES`,`STATUS`) values ('1','admin','admin','1','系统管理员','0','71@qq.com','0','2','22278009771',NULL,0,'2015-03-18 08:22:03',0,'2016-12-13 09:46:03','127.0.0.1',286,'1'),('5','test','test','1','test','1','test@test.com','test','test','test','',0,'2015-04-28 00:08:26',0,'2016-05-18 16:19:11','0:0:0:0:0:0:0:1',9,'1');
